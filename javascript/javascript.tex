...
\subsection{Escopo de Classe e de Instância} % (fold)
...
\end{verbatim}
% subsection Escopo de Classe e de Instância (end)

\subsection{Protótipo de Objetos} % (fold)
...
\subsubsection{Noções básicas sobre objetos de protótipos} % (fold)
...
person1.valueOf();
\end{verbatim}
% subsubsection Noções básicas sobre objetos de protótipos (end)
% subsection Protótipo de Objetos (end)


\subsection{Herança em JavaScript} % (fold)
...
\subsubsection{Herdando construtor sem parâmetros} % (fold)
...
% subsubsection Herdando construtor sem parâmetros (end)

\subsubsection{Definindo o protótipo e referência de cosntrutor de subclasse.} % (fold)
...
\end{verbatim}
% subsubsection Definindo o protótipo e referência de cosntrutor de subclasse. (end)
% subsection Herança em JavaScript (end)

\subsection{Classes Ecmascript 2015} % (fold)
...
\end{verbatim}
% subsection Classes Ecmascript 2015 (end)

\subsection{Trabalhando com JSON} % (fold)
...
% subsection Trabalhando com JSON (end)
